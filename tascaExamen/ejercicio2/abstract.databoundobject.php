...
abstract class DataBoundObject {
   ...
   public function Load() {
      ...
      if (isset($this->ID)) {
        ...
        foreach($arRow as $key => $value) {
         ...
         $log->logMessage("Funcion Load " . $strQuery, Logger::INFO);
      };
   ...
   public function Save() {
      ...
      if (isset($this->ID)) {
         $log = Logger::getInstance();
         $log->logMessage("Funcion Save ID " . $this->ID, Logger::DEBUG);
   ...
   public function __destruct() {
      $log = Logger::getInstance();
      $log->logMessage("Funcion __destruct ID " . $this->ID, Logger::CRITICAL);
   ...
   private function SetAccessor($strMember, $strNewValue) {
      $log = Logger::getInstance();
      $log->logMessage("Funcion Set " . $strMember . ' - ' . $strNewValue, Logger::NOTICE);
   ...
   private function GetAccessor($strMember) {
      $log = Logger::getInstance();
      $log->logMessage("Funcion Get " . $strMember, Logger::NOTICE);
